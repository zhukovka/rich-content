...
The `config` prop allow to customize various aspects of the `RichContentEditor`, such as [toolbars](./ToolbarCustomization.mdx), [common UI settings](./UiSettings.mdx), and [plugins](../plugins_api/PluginCustomization.md).
