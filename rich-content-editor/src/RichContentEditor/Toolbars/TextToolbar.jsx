...
const activeButtons = reqeustedButtons => {
  ...
  reqeustedButtons.forEach(buttonName => {
    switch (buttonName) {
      case 'Bold':
        buttons.push(BoldButton);
        break;
      case 'Italic':
        buttons.push(ItalicButton);
        break;
      case 'Title':
        buttons.push(TitleButton);
        break;
      case 'Blockquote':
        buttons.push(BlockquoteButton);
        break;
      case 'Alignment':
        buttons.push(TextAlignmentButton);
        break;
      case 'OrderedList':
        buttons.push(OrderedListButton);
        break;
      case 'UnorderedList':
        buttons.push(UnorderedListButton);
        break;
      case 'Link':
        buttons.push(TextLinkButton);
        break;
      case 'Separator':
        buttons.push(StyledSeparator);
        break;
      default:
