 ...
 */
export const mergeButtonLists = (sourceList, positionedList, formFactor = 'desktop', onInsert = ({ mergedList }) => mergedList) => {
  return positionedList.reduce((mergedList, buttonData) => {
    if (buttonData.name) {
      if (buttonData.position && buttonData.position[formFactor] &&
