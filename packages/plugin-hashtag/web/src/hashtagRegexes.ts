...
// Taken from https://github.com/draft-js-plugins/draft-js-plugins/blob/master/draft-js-hashtag-plugin/src/utils/hashtagRegex.js
...
function regexSupplant(regex: RegExp | string, flags?: string) {
  flags = flags || '';
