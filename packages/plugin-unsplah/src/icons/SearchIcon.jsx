...
const SearchIcon = props => (
  <svg width={13} height={13} viewBox="0 0 13 13" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g id="unsplash-Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g id="unsplash-window" transform="translate(-234.000000, -20.000000)">
        <g id="unsplash-Find-Member-Copy" opacity="0.7" transform="translate(234.000000, 20.000000)" fill="#000000" fillRule="nonzero">
          <g id="unsplash-Find-Member">
            <g id="unsplash-Search-Icon">
