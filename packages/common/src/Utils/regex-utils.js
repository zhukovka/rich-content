// LICENSE : MIT
// https://github.com/azu/match-index
'use strict';
import flagsGetter from 'regexp.prototype.flags';
...
export function matchAll(text, regExp) {
  ...
  text.replace(rx, function () {
    ...
    const captureGroups = [];
    /* eslint-disable fp/no-loops, no-constant-condition */
    ...
    /* eslint-enable fp/no-loops, no-constant-condition */
